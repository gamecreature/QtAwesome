...
QSize QtAwesome::iconSize(int dpi, int type)
{
    QSize iconSize;
    switch (dpi) {
    case dpiset::mdpi:
...
/// </code>
QString QtAwesome::iconLink(int character, const QVariantMap &options, int dpi, int type)
{
...
/// </code>
QString QtAwesome::iconLink(const QString& name, const QVariantMap &options, int dpi, int type)
{
    if( namedCodepoints_.count(name) ) {
